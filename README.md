...
The merging of pseudo-labels is done after a class-wise evaluation for each  to determine which Component after refinement has the high score for each class $c$ with 
$1 \leq c \leq C$ :
